...
export const heroData: HeroData = {
  ...
  subtitle: ["Enabling Success\n Your Partner in End-to-End Business Solutions."],
  description: "Discover unparalleled business support with ISA COMPANIES LTD your beacon for comprehensive solutions. We pride ourselves on empowering success through innovation and unwavering integrity. At ISA, every challenge is met strategically, ensuring your journey to excellence is seamless and rewarding.",
...
export const featureItems: Feature[] = [
  {
    ...
    description: "ISA's commercial division strives to be a reliable partner, providing businesses with accurate market insights and value-added brokerage services fostering effective communication with clientele for long-term success.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "This product line strives to empower clients and build lasting relationships through services in performance management, sales, marketing. Our philosophy emphasizes trust and respect, serving diverse client groups including government, private sector, banks, and social organizations.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Business Solutions Centre",
    description: "CBS, a division of ISA Companies Limited, provides comprehensive services including business incubation, development, training, and access to finance, serving as a one-stop solution for various business needs.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Our Foreign Companies Representation service promotes joint ventures between foreign and local companies in East Africa. We facilitate project establishment, operation, and advise on policies to boost local and regional investment.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Our Procurement & Logistics division is dedicated to improving the commercial performance of clients across various sectors. We uphold our Quality Service Promise by prioritizing speed, efficiency, personalized services, and responsive action based on customer feedback.",
  },
];
...
export const featureIcons =  [
  ...
  // Add more icon objects here with id and svg properties
  // Example:
  {
    id: 3,
    svg: (
...
description:"Committed to providing a stress-free business experience with superior services that cater for our customers",
text:( <p className="mb-6 text-gray-400">
...
motto:"Our Motto: “Business solutions”"
}
