            ...
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:flex lg:items-center">
                    <div className="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">explore our <br /> awesome services</h1>
                        ...
                        {featureItems.map((item, index) => (
                            <div key={index} className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">{item.title}</h1>
                                    <p className="mt-3 text-gray-500 dark:text-gray-300">{item.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                        <img alt='feature image' className="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=755&q=80" />
                    </div>
                </div>
